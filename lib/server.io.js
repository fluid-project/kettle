/**
 * Kettle support for server.io WebSockets-based I/O
 *
...
fluid.defaults("kettle.server.io", {
    ...
    listeners: {
        onCreate: {
            priority: "first", // TODO: race with server's onCreate registerHandlers
            listener: "kettle.server.io.createIo"
        },
        onRegisterIOHandler: [{
...
kettle.server.io.createIo = function (that) {
    fluid.log("Initializing the socket.io member");
