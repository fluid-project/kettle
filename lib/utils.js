...
kettle.withRequest = function (request, callback) {
    return function wrapCallback () {
        ...
        // TODO: Although in theory this could be removed now that when.js is gone, there are still use cases where the user may supply, e.g.
        // synchronously resolving promises. We should improve the underlying FluidIoC implementation instead
...
kettle.utils.failureHandler = function (args, activity) {
    ...
    fluid.builtinFail(true, args, activity);
};
