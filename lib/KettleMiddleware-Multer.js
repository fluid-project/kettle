...
fluid.defaults("kettle.middleware.multer", {
    ...
    components: {
        storage: {
            type: "kettle.middleware.multer.diskStorage"
        }
    },
...
fluid.defaults("kettle.middleware.multer.diskStorage", {
    ...
    invokers: {
        destination: {
            filename: {
                funcName: "kettle.middleware.multer.defaultDestination",
                args: ["{that}.options.destination"]
            }
        },
        filenameName: {
            func: "kettle.middleware.multer.diskStorage.defaultFilename",
            args: ["{that}.options.filename"]
        }
    }
});

kettle.middleware.multer.defaultDestination = function (destination) {
...
kettle.middleware.multer.defaultFilename = function (filename) {
    return function (req, file, cb) {
