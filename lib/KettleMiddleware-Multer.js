...
fluid.defaults("kettle.middleware.multer", {
    ...
    members: {
        ...
        // the function that just calls multer.diskStorage with
       // the appropriate configuration object structure and the
       // diskStorageDestination and diskStorageFilename invoker
       // references), but that doesn't mean the syntax doesn't exist
        "diskStorage": {
            expander: {
