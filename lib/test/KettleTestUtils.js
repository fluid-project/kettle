...
kettle.test.request.io.connect = function (that) {
    ...
    options.path = kettle.dataSource.urlResolver.resolve(null, options.path, that.options.termMap);
...
kettle.test.request.http.send = function (that, requestOptions, termMap, cookieJar, callback, model) {
    ...
    options.path = kettle.dataSource.urlResolver.resolve(null, options.path, termMap);
