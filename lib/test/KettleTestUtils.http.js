...
kettle.test.request.prepareRequestOptions = function (componentOptions, cookieJar, userOptions, permittedOptions) {
    ...
    requestOptions.path = kettle.dataSource.urlResolver.resolve(null, requestOptions.path, requestOptions.termMap);
...
kettle.test.request.http.requestOptions = ["host", "hostname", "family", "port", "localAddress", "socketPath", "method", "path", "headers", "auth", "agent", "termMap"];
