...
kettle.test.request.http.prepareRequestOptions = function (options, cookieJar, directOptions, permittedOptions) {
    ...
    var togo = fluid.dataSource.URL.prepareRequestOptions(options, cookieJar, directOptions, permittedOptions);
    delete togo.path;
 ...
 * @param {Options} options - options containing the core fields listed above
 */
