...
(function () {
    ...
    fluid.defaults("kettle.sessionManager.requestSession", {
        ...
        invokers: {
            destroySession: {
                ...
                args: ["{callbackWrapper}", "{that}.session",
                    "{that}.events.afterDestroySession"]
            },
            getSessionTypeGrade: {
     ...
     * @param  {Object} callbackWrapper Callback wrapper.
     * @param  {Object} session session object.
     * @param  {Object} afterDestroySession event fired when session is
     * destroyed.
     */
    kettle.sessionManager.requestSession.destroySession = function (callbackWrapper, session, afterDestroySession) {
        var wrappedAfterDestroySession =
            callbackWrapper.wrap(afterDestroySession.fire);
