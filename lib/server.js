...
fluid.defaults("kettle.server", {
    gradeNames: ["kettle.use.bodyParser", "fluid.eventedComponent", "autoInit"],
    distributeOptions: {
        record: "kettle.server.dataSource.errback",
        target: "{that dataSource errback}.options.gradeNames"
    },
    components: {
        requests: {
...
fluid.defaults("kettle.server.dataSource.errback", {
    gradeNames: ["fluid.eventedComponent", "autoInit"],
    listeners: {
        onError: {
            namespace: "handleError",
            funcName: "kettle.server.dataSource.errback.handleError",
            args: [
                "{requestProxy}",
                "{arguments}.0"
            ]
...
kettle.server.dataSource.errback.handleError = function (requestProxy, data) {
