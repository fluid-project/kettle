...
kettle.middleware.toPromise = function (middleware, request, async) {
...
kettle.plainMiddleware.resolve = function (that, request, async) {
    ...
    return kettle.middleware.toPromise(middleware, request, async);
};
 ...
 * @param {String|String[]} allowMethods - methods that are enabled with CORS.
 * @param {String|String[]} origin - domains that are allowed.
