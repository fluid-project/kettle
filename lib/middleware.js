...
(function () {
    ...
    fluid.defaults("kettle.middleware.CORS", {
        ...
        // Note that simple GET requests are not preflighted, and so if a
        // request is made for a resource with credentials, if this header is
        // not returned with the resource, the response is ignored by the
