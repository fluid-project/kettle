...
(function () {
     ...
     */
    // TODO: There are not currently any tests for this functionality - any more than there
    // were for the previous "handler.when" which is replaces
    ...
    fluid.defaults("kettle.requests.request.handler", {
        gradeNames: ["autoInit", "fluid.eventedComponent", "{request}.handlerContext", "fluid.applyGradeLinkage"],
        invokers: {
