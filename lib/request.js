...
(function () {
    ...
    fluid.defaults("kettle.requestProxy.io", {
        gradeNames: ["autoInit", "kettle.requestProxy"],
        events: {
            onError: null,
            onSuccess: null
        },
        listeners: {
            onError: "{kettle.requests}.onErrorHandlerIO",
            onSuccess: "{kettle.requests}.onSuccessHandlerIO"
        }
    });
    ...
    kettle.requests.io.eventHandler = function (that, eventName, args) {
        ...
        instantiator.clearComponent(that, request.name);
    };
    ...
    fluid.defaults("kettle.requests.request", {
        ...
        invokers: {
            ...
            getRequestGrade: {
                funcName: "fluid.model.composeSegments",
                args: ["{kettle.requests}.typeName", "request"]
            }
        },
        components: {
            handler: {
