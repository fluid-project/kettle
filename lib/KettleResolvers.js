 ...
 * @param name {String} The name of the environment variable to return
 * @param fallback {String} The value returned if the environment variable cannot be found
 * @return {String|Undefined} The value of the required environment variable,
 * the default value, or `undefined` if there is no value.
 */

kettle.resolvers.env = function (name, defaultValue) {
 ...
 * @param fileName {String} The name of the file to be resolved, which may begin
 ...
 * @param index {Integer} [optional] The index of the required process argument.
 * @return {String|Undefined|Array of String} The required process argument if it
