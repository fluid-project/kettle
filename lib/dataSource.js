...
// TODO: This handler has NO test coverage - we should construct some for this and CouchDB "writeMethod" using express-pouchdb
    kettle.dataSource.URL.handle.http = function (path, options, data) {
        ...
        if (options.operation === "set") {
            ...
            requestOptions.method = options.writeMethod || "PUT"; // TODO: supports the dominant use-case of writing existing documents to CouchDB
        }
