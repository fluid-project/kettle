...
fluid.defaults("kettle.tests.dataSource.5.recursiveFile", {
    ...
    invokers: {
        errorFunc: {
            ...
            args: [{
                isError: true,
                message: fluid.module.resolvePath("File Idontexist.json was not found when searching from path %kettle/tests/data/"),
                statusCode: 404
            }, "{arguments}.0"]
        }
    }
...
fluid.defaults("kettle.tests.dataSource.6.recursiveFile", {
    gradeNames: ["kettle.tests.simpleDataSourceTest"],
    name: "Recursive file datasource: path is not a folder",
    shouldError: true,
    components: {
        dataSource: {
            type: "kettle.dataSource.recursiveFile.moduleTerms",
    ...
    invokers: {
        errorFunc: {
            ...
            args: [{
                isError: true,
                message: fluid.module.resolvePath("Error while searching for file... ENOTDIR: not a directory, scandir '%kettle/tests/data/dataSourceTestFile.json'"),
                statusCode: 500
            }, "{arguments}.0"]
        }
    }
...
fluid.defaults("kettle.tests.dataSource.7.recursiveFile", {
    gradeNames: ["kettle.tests.simpleDataSourceTest"],
    name: "Recursive file datasource: path is not existent",
    shouldError: true,
    components: {
        dataSource: {
            type: "kettle.dataSource.recursiveFile.moduleTerms",
            options: {
                path: "%kettle/tests/idontexistdir",
                filename: "dataSourceTestFile.json"
            }
        }
    },
    invokers: {
        errorFunc: {
            ...
            args: [{
                isError: true,
                message: fluid.module.resolvePath("Error while searching for file... ENOENT: no such file or directory, scandir '%kettle/tests/idontexistdir'"),
                statusCode: 500
            }, "{arguments}.0"]
        }
    }
...
fluid.defaults("kettle.tests.dataSource.8.recursiveFile", {
    gradeNames: ["kettle.tests.simpleDataSourceTest"],
    ...
    invokers: {
        errorFunc: {
            ...
            args: [{
                isError: true,
                message: fluid.module.resolvePath("File nested was not found when searching from path %kettle/tests/data"),
                statusCode: 404
            }, "{arguments}.0"]
        }
    }
...
fluid.defaults("kettle.tests.dataSource.9.recursiveFile", {
    gradeNames: ["kettle.tests.simpleDataSourceTest"],
...
kettle.tests.dataSource.standardTests = [
    ...
    "kettle.tests.dataSource.8.recursiveFile",
    "kettle.tests.dataSource.9.recursiveFile"
];
